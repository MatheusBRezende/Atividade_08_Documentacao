...
public class AutoresController : ControllerBase
{
    ...
    /// <summary>
    /// Lista todos os autores cadastrados na biblioteca.
    /// </summary>
    /// <returns>Uma lista de autores.</returns>
    /// <response code="200">Retorna a lista de autores com sucesso.</response>
    [HttpGet]
    ...
    /// </summary>
    /// <param name="id">ID único do autor.</param>
    /// <returns>Os dados do autor solicitado.</returns>
    /// <response code="200">Autor encontrado com sucesso.</response>
    /// <response code="404">Nenhum autor encontrado com o ID fornecido.</response>
    [HttpGet("{id:int}")]
    ...
    /// </summary>
    /// <param name="autor">Objeto com os dados do autor (Nome é obrigatório).</param>
    /// <returns>O autor recém-criado.</returns>
    ...
    /// <response code="204">Autor atualizado com sucesso (sem conteúdo de retorno).</response>
    /// <response code="404">Autor não encontrado para atualização.</response>
    [HttpPut("{id:int}")]
